		...
		<ec:table items="approveInfos" var="approveInfo"
			...
			<ec:row highlightRow="true">
				...
				<ec:column property="approveContent" calcTitle="approveContent"
					title="审核意见" />
				<ec:column property="null" title="附件信息" width="20%">
					<c:if test="${approveInfo.appAnnexAddr!=null}">
						<a href="<%=request.getContextPath()%>/ctrProcessCtrAction.do?method=downloadSingle&flag=100&id=${approveInfo.id }">${approveInfo.appAnnex}</a>
					</c:if>
				</ec:column>	
