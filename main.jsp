...
<html>
	...
	<frameset cols="*,100%,*" frameborder="no" border="0" framespacing="0">
		...
		<frameset id="bigmainFrame" name="bigmainFrame" rows="76,0,31,*,30"
			...
			<frame id="tmenuFrame" name="tmenuFrame" scrolling="auto"
				src="bizplat.do?method=bizPlatTree&code=0&nodecode=${ctarget}&subPage=${subPage}"/>
			<frameset cols="175,5,*" id="mainFrame" name="mainFrame" border="0"
				frameborder="no">
				<!-- 二级菜单框架 -->
				<frame id="menuFrame" src="bizplat.do?method=bizPlatSubMenu&nodecode=${ctarget}"
					name="menuFrame" />
				<!-- 收缩框架 -->
