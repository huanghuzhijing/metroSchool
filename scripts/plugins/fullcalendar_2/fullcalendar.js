...
function Header(calendar, options) {
	...
	function render() {
		...
		if (sections) {
			...
			var _l = $('<tr/>').append(renderSection('left'));
			var _c = $('<tr/>').append(renderSection('center'));
			var _r = $('<tr/>').append(renderSection('right'));
			element = $("<table class='fc-header' style='width:100%'/>").append(_l).append(_c).append(_r);
			return element;
		}
	}
