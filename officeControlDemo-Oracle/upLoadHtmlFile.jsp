...
<%
	...
	for(int i=0;i<itemsArray.length;i++)
	{
		...
		{
			htmlFileName = curFileItem.getString("gbk");
		}
		else{
	...
	for(int i=0;i<itemsArray.length;i++)
	{
		...
		if(curFileItem.isFormField())
		{
			out.println("FieldName=" +curFileItem.getFieldName()+"|fileName="+curFileItem.getString("gbk")+"<br>");
		}
		else
		{
		out.println("FieldName=" +curFileItem.getFieldName()+"|fileName="+curFileItem.getName()+"<br>");
		}
	}
	//*/
