...
if (browser=="IE"){
	...
	document.write('codebase="/XCLand/officeControlDemo-Oracle/officecontrol/ofctnewclsid.cab#version=5,0,2,7" width="100%" height="100%">   ');
...
document.write('<param name="ProductCaption" value="华中科技大学">  ');
document.write('<param name="ProductKey" value="F36785D9FEC4ABC9568DA05A51229ED7D4CCF2D3"> ');
	...
	document.write('<param name="WebUserName" value="">   ');
	document.write('<param name="Caption" value="">   ');
	document.write('<SPAN STYLE="color:red">不能装载文档控件。请在检查浏览器的选项中检查浏览器的安全设置。</SPAN>   ');
	document.write('</object>');
}
else if (browser=="firefox"){ 	
		document.write('<object id="TANGER_OCX" type="application/ntko-plug"  codebase="/XCLand/officeControlDemo-Oracle/officecontrol/ofctnewclsid.cab#version=5,0,2,7" width="100%" height="100%" ForOnSaveToURL="OnComplete2" ForOnBeginOpenFromURL="OnComplete2" ForOndocumentopened="OnComplete3"');
...
document.write('_ProductCaption="华中科技大学" ');
document.write('_ProductKey="F36785D9FEC4ABC9568DA05A51229ED7D4CCF2D3" ');
		...
		document.write('<SPAN STYLE="color:red">尚未安装NTKO Web FireFox跨浏览器插件。请点击<a href="loginsystem.do?method=uploadPlugin">安装组件</a></SPAN>   ');
		document.write('</object>   ');
...
document.write('_ProductKey="F36785D9FEC4ABC9568DA05A51229ED7D4CCF2D3" ');
		...
		document.write('codebase="/XCLand/officeControlDemo-Oracle/officecontrol/ofctnewclsid.cab#version=5,0,2,7" width="100%" height="100%" type="application/ntko-plug" ');
		document.write('_IsUseUTF8URL="-1"   ');
		document.write('_IsUseUTF8Data="-1"   ');
		document.write('_BorderStyle="1"   ');
		document.write('_BorderColor="14402205"   ');
		...
		document.write('_MenuBarStyle="3"  ');
		document.write('_MenuButtonStyle="7"   ');
		document.write('_WebUserName=""   ');
		document.write('_Caption="">    ');
		document.write('<SPAN STYLE="color:red">尚未安装NTKO Web Chrome跨浏览器插件。请点击<a href="loginsystem.do?method=uploadPlugin">安装组件</a></SPAN>   ');
		document.write('</object>');
	}else if (Sys.opera){
