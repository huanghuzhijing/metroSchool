		...
		<tr>
			...
			<td align="center" valign="top" colspan="2">
				<table class="showTable" style="margin-top: 10px;">
					...
					<tr height="40">
						<td>
							<a style="color: #024280" href="${ctx}/dtaqLaunchingMethodAction.do?method=showView&station_id=${station.station_id}&mode=${mode}" target="mainFrame">工法</a>
						</td>
					</tr>
					<tr height="40">
						<td>
							<a style="color: #024280" href="${ctx}/dtaqConstructionMethodAction.do?method=showView&station_id=${station.station_id}&mode=${mode}" target="mainFrame">辅助工法</a>
						</td>
					</tr>
					
					<tr height="40">
						<td>
							<a style="color: #024280" href="${ctx}/dtaqBuildingAction.do?method=showView&station_id=${station.station_id}&mode=${mode}" target="mainFrame">建筑物</a>
						</td>
					</tr>
					<tr height="40">
						<td>
							<a style="color: #024280" href="${ctx}/dtaqPipeAction.do?method=showView&station_id=${station.station_id}&mode=${mode}" target="mainFrame">管线</a>
						</td>
					</tr>
					<c:if test="${mode == null}">
						<tr height="40">
