...
<ec:table items="dtaqDatas" var="data" action="dtaqDataQueryAction.do"
	...
	retrieveRowsCallback="limit" filterRowsCallback="limit" sortRowsCallback="limit">
	  ...
	  <ec:column property="part_id" title="监测部位" width="100px">
	  ...
	  <ec:column property="point_code" title="测点编码" width="120px">
	  	<span style="color:#286fdb;cursor:pointer" onclick="showPointDetail(${data.point_id.point_id})">${data.point_code}</span>
	  </ec:column>
	  <ec:column property="write_date" title="监测日期" width="120px">
	  	<span style="color:#286fdb;cursor:pointer" onclick="showSchedule('${data.part_id.station_id.station_id}','${data.write_date}')"><fmt:formatDate value="${data.write_date}" pattern="yyyy-MM-dd"/></span>
	  </ec:column>
	  <ec:column property="init_value" title="${type.init_value_title}" width="120px"/>
