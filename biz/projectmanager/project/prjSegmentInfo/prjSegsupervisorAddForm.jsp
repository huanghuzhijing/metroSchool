	...
	<script type="text/javascript">
	   $(document).ready(function(){
			...
			$("#btn_save").click(function(){
				...
				saveValidateRequired("#btn_save",properties,"prjSegmentSupervisorForm");
			}); 
			//
...
<body>
	...
	<html:form enctype="multipart/form-data" action="prjSegmentSupervisorAction.do" method="POST">
		...
		<fieldset >
			...
			<table class="formTable" >
					...
					<tr>
						<td>
							监理标段编号：<span class="redSpan">*</span>
						</td>
						<td >
							<html:text property="supSegCode" styleClass="inputText" maxlength="100" size="48"/>
						</td>
					</tr>
					<tr>
						<td>
							监理标段名称：<span class="redSpan">*</span>
						</td>
						<td>
							<html:text property="supSegName" styleClass="inputText" maxlength="100" size="48"/>
						</td>
					</tr>
					<tr>
						<td>
							关联的标段：<span class="redSpan">*</span>
						</td>
						<td>
							<html:text property="segNames" styleClass="inputText" maxlength="100" size="48"/>
						</td>
					</tr>
					<tr>
						<td>
