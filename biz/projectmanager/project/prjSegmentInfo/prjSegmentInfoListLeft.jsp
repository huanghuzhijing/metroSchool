	...
	<script type="text/javascript">
		...
		function showGridTree(){
			...
			<c:forEach items="${prjTypeTrees}" var="prjTypeTree">
				...
				var nodeUrl='${ctx}/prjSegmentInfoAction.do?method=listRight&staticPrjStatus=${prjTypeTree.prjStatus}&prjId=${prjTypeTree.nodeId}&staticPrjId=${prjTypeTree.nodeId}';
