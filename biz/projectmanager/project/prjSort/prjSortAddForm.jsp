...
<body>
	...
	<html:form enctype="multipart/form-data" action="prjSortAction.do" method="POST">
		...
		<html:hidden property="parentId" value="${param.staticParentId}"/>
		<fieldset >
			<legend>工程子类-新增</legend>
			<table class="formTable" >
					...
					<tr>
						...
						<td colspan="3">
						<html:text property="orderNum"  styleClass="inputText" maxlength="100" usage="int+" size="30"/>
						</td>
					</tr>
					<tr>
						<td>
