...
<body>
	<html:form enctype="multipart/form-data" action="prjCorpUserJoinAction.do?method=saveSegForSurv" method="POST">
	...
	<ec:table items="prjSegmentInfos" var="prjSegmentInfo" 
		action="prjCorpUserJoinAction.do?method=selectSegForSurv" title=""  locale="zh_CN"
