...
<body>
	<html:form enctype="multipart/form-data" action="prjCorpUserJoinAction.do?method=saveEmpForSurv" method="POST">
	...
	<ec:table items="employees" var="employee" 
		action="prjCorpUserJoinAction.do?method=selectEmpForConstr" title="" width="100%" locale="zh_CN"
