...
<body>
	<html:form enctype="multipart/form-data" action="prjCorpUserListAction.do?method=saveSeg" method="POST">
	...
	<ec:table items="prjSegmentInfos" var="prjSegmentInfo" 
		action="prjCorpUserListAction.do?method=selectSeg" title=""  locale="zh_CN"
