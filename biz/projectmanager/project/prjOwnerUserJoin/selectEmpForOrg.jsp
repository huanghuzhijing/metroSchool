...
<body>
	<html:form enctype="multipart/form-data" action="prjOwnerUserJoinAction.do?method=saveEmpForOrg" method="POST">
	...
	<ec:table items="employees" var="employee" 
		action="prjOwnerUserJoinAction.do?method=selectEmpForConstr" title="" width="100%" locale="zh_CN"
