...
//人员选择
	...
	function pageRefresh(){
		var url='prjOwnerUserJoinAction.do?method=tab&prjId=${projectInfo.id}&ec_p=${param.ec_p}&ec_id=${projectInfo.id}&ec_auditStatus=${projectInfo.auditStatus}&staticPrjSort=${param.staticPrjSort}&staticFootNode=${param.staticFootNode}&flag=${param.flag}';
		commonUrl(url);
	}
