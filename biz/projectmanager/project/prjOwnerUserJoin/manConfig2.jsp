...
//人员选择
	...
	function pageRefresh(){
		var url='prjOwnerUserJoinAction.do?method=manConfig&prjId=${projectInfo.id}&ec_p=${param.ec_p}&ec_id=${projectInfo.id}&ec_auditStatus=${projectInfo.auditStatus}&staticPrjSort=${param.staticPrjSort}&staticFootNode=${param.staticFootNode}&flag=${param.flag}';
		commonUrl(url);
	}
	//编辑 业主
	function orgEdit(id){
...
<body>
	<html:form enctype="multipart/form-data" action="prjOwnerUserJoinAction.do?method=list&staticPrjStatus=${param.staticPrjStatus}&ec_p=${param.ec_p}&ec_id=${projectInfo.id}&ec_auditStatus=${projectInfo.auditStatus}&staticPrjSort=${param.staticPrjSort}&staticFootNode=${param.staticFootNode}&flag=${param.flag}" method="POST">
		<!--查询定位 开始-->
