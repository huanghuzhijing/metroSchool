...
<body>
	<html:form enctype="multipart/form-data" action="prjOwnerUserJoinAction.do?method=saveEmpForConstr" method="POST">
	...
	<ec:table items="employees" var="employee" 
		action="prjOwnerUserJoinAction.do?method=selectEmpForConstr" title=""  locale="zh_CN"
