...
<script type="text/javascript">
	...
	$(document).ready(function(){
       ...
       $("#btn_docSort").click(function(){
      		var url ='projectInfoAction.do?method=editDocSort'+'&id='+oper_id+'&ec_p='+$("input[name='ec_p']").val()+'&staticPrjStatus=${param.staticPrjStatus}&staticPrjType=${param.staticPrjType}&staticFootNode=${param.staticFootNode}&flag=${param.flag}';
			commonUrl(url);
       });
       //
