...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("#btn_add").click(function(){ 
			location.href='projectInfoAction.do?method=create&staticPrjStatus=${param.staticPrjStatus}&staticPrjType=${param.staticPrjType}&staticFootNode=${param.staticFootNode}';
		}); 
		//
		...
		$("#btn_delete").click(function(){ 
			...
			if(ret){
				var url='projectInfoAction.do?method=delete&staticPrjStatus=${param.staticPrjStatus}&id='+oper_id+'&ec_p='+$("input[name='ec_p']").val()+'&staticPrjType=${param.staticPrjType}&staticFootNode=${param.staticFootNode}';
				commonUrl(url);
			}
		});
		//
		...
		$("#btn_segment").click(function(){
			var url='prjSegmentInfoAction.do?method=list&staticPrjStatus=${param.staticPrjStatus}&staticPrjId='+oper_id+'&parent_ec_p='+$("input[name='ec_p']").val()+'&staticPrjSort=${param.staticPrjSort}&staticFootNode=${param.staticFootNode}';
			commonUrl(url);
		}); 
		//
       ...
       $("#btn_submit").click(function(){
			...
			if(ret){
				var url='projectInfoAction.do?method=upReport&id='+oper_id+'&ec_p='+$("input[name='ec_p']").val()+'&staticPrjStatus=${param.staticPrjStatus}&staticPrjType=${param.staticPrjType}&staticFootNode=${param.staticFootNode}'+'&ec_auditStatus=1&ec_id='+oper_id;
      			commonUrl(url);
			}
       });
       //
       $("#btn_pass").click(function(){
			...
			if(ret){
				var url='projectInfoAction.do?method=pass&id='+oper_id+'&ec_p='+$("input[name='ec_p']").val()+'&staticPrjStatus=${param.staticPrjStatus}&staticPrjType=${param.staticPrjType}&staticFootNode=${param.staticFootNode}'+'&ec_auditStatus=-1&ec_id='+oper_id;
      			commonUrl(url);
			}
       });
       //
       $("#btn_nopass").click(function(){
			...
			if(ret){
				var url='projectInfoAction.do?method=nopass&id='+oper_id+'&ec_p='+$("input[name='ec_p']").val()+'&staticPrjStatus=${param.staticPrjStatus}&staticPrjType=${param.staticPrjType}&staticFootNode=${param.staticFootNode}'+'&ec_auditStatus=-2&ec_id='+oper_id;
      			commonUrl(url);
			}
       });
       //
       $("#btn_manView").click(function(){
      		var url ='projectInfoAction.do?method=manView'+'&id='+oper_id+'&ec_p='+$("input[name='ec_p']").val()+'&staticPrjStatus=${param.staticPrjStatus}&staticPrjType=${param.staticPrjType}&staticFootNode=${param.staticFootNode}';
			commonUrl(url);
       });
       //
       $("#btn_manConfig").click(function(){
      		var url ='projectInfoAction.do?method=manConfig'+'&id='+oper_id+'&ec_p='+$("input[name='ec_p']").val()+'&staticPrjStatus=${param.staticPrjStatus}&staticPrjType=${param.staticPrjType}&staticFootNode=${param.staticFootNode}';
			commonUrl(url);
       });
       //
       $("#btn_docSort").click(function(){
      		var url ='projectInfoAction.do?method=editDocSort'+'&id='+oper_id+'&ec_p='+$("input[name='ec_p']").val()+'&staticPrjStatus=${param.staticPrjStatus}&staticPrjType=${param.staticPrjType}&staticFootNode=${param.staticFootNode}';
			commonUrl(url);
       });
       //
	...
	function showView(id){
    	var url ='projectInfoAction.do?method=view'+'&id='+id+'&ec_p='+$("input[name='ec_p']").val()+'&staticPrjStatus=${param.staticPrjStatus}&staticPrjType=${param.staticPrjType}&staticFootNode=${param.staticFootNode}'+'&viewFlag=true';
		commonUrl(url);
  	}
  	//编辑页面
	function commonEdit(id){
    	var url='projectInfoAction.do?method=edit&staticPrjStatus=${param.staticPrjStatus}&id='+id+'&ec_p='+$("input[name='ec_p']").val()+'&staticPrjType=${param.staticPrjType}&staticFootNode=${param.staticFootNode}';
		commonUrl(url);
  	}
  	//设置list页面id
	...
	function pageRefresh(){
		var url='projectInfoAction.do?method=list&ec_p='+$("input[name='ec_p']").val()+'&staticPrjStatus=${param.staticPrjStatus}&staticPrjType=${param.staticPrjType}&staticFootNode=${param.staticFootNode}';
      	commonUrl(url);
	}
</script>
</head>
       ...
       <tr>
       	 <td valign="top" > 
	          <div style="overflow: auto;"  >
					<script language='javascript'>
						...
						projectInfoTree.add('-1',-99,'项目总汇(${totalPrjCount})','${ctx}/projectInfoAction.do?method=list');
						<c:forEach items="${prjTypeTrees}" var="prjTypeTree">		
							projectInfoTree.add('${prjTypeTree.nodeId}','-1','${prjTypeTree.nodeName}(${prjTypeTree.prjCount})','projectInfoAction.do?method=list&staticPrjStatus=${prjTypeTree.prjStatus}','','','','');
						</c:forEach>
         ...
         <td valign="top" width="85%">
	          <table class="queryTable" >
					...
					<tr>
						<td>
							<html:form action="projectInfoAction.do?method=list&staticPrjStatus=${param.staticPrjStatus}&staticPrjType=${param.staticPrjType}&staticFootNode=${param.staticFootNode}">
								<table class="queryContentTable">
									<tr>
										...
										<td>
											<ex:dictSelect property="qauditStatus" type="AuditState"/> 
										</td>
										<td >
				...
				<div  class="listButtonDiv">
					...
					<input id="btn_segment" value="标段划分" type="button" icon="icon_add" />
					...
					<input id="btn_manConfig" value="业主方人员分配" type="button" icon="icon_edit" />
					<input id="btn_manView" value="项目委派预览" type="button" icon="icon_view"/>
					<input id="btn_docSort" value="关联工程文档目录" type="button" icon="icon_edit"/>
