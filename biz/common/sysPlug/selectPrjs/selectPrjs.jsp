...
<script type="text/javascript">
	...
	$(document).ready(function(){
			$("#plug_btnSelect").click(function(){ 
					...
					//
					var url = "contentSelectAction.do?method=selectPrjSegments&queryType=${queryType}";
					art.dialog({id:'commonDialog1',title:'项目选择', iframe:url, width:'600', height:'425',top:'110'}).close(function(){
					  	//
	...
	<input id="plug_btnSelect" value="项目选择" type="button"  class="button1" icon="icon_selectInfo" />
