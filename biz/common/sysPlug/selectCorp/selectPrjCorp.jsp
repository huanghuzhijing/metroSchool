	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$(".selectButton").click(function(){ 
				parent.$("#plug_corpId").val($(this).attr("paramId"));
				parent.$("#plug_corpType").val($(this).attr("paramName"));
				parent.$("#plug_corpName").val($(this).attr("paramArray"));
...
<body>
	<table class="queryTable" >
		...
		<tr>
			<td>
				<html:form action="contentSelectAction.do?method=selectCorp&queryCorpType=${queryCorpType}">
					<table class="queryContentTable">
						<tr>
							...
							<td>
								<input type="button" icon="icon_add" value="单位增加" onclick="corpadd()"/>
							</td>
						</tr>
					</table>
				</html:form>
	...
	<ec:table items="corps" var="corp"
		action="contentSelectAction.do?method=selectCorp&queryCorpType=${queryCorpType}" title="" locale="zh_CN"
