...
<script type="text/javascript">
	...
	$(document).ready(function(){
			//
			$("#plug_selectOaCtr").click(function(){
				var paramWindow=$("[name='paramWindow']").val();
				if(paramWindow==1){
					var url ='contentSelectAction.do?method=selectOaCtr&paramWindow=1&queryCtrType=${queryCtrType}&prj_id='+$("#prj_id").val();
					window.open(url,"合同信息","");
				}else{
					var url ='contentSelectAction.do?method=selectOaCtr&queryCtrType=${queryCtrType}&prj_id='+$("#prj_id").val();
	...
	<input id="plug_selectOaCtr" value="选择" type="button"  icon="icon_selectInfo"/>
