	...
	<script type="text/javascript">
		$(document).ready(function(){
			$(".selectButton").click(function(){ 
				parent.$("#plug_corpIds_2").val($(this).attr("paramId")); 
				parent.$("#plug_corpNames_2").val($(this).attr("paramName"));
...
<body>
 <table class="queryTable" >
		...
		<tr>
			<td>
				<html:form action="contentSelectAction.do?method=corpSelects_2&corptype=3">
	...
	<ec:table items="organizations" var="organization"
				action="contentSelectAction.do?method=corpSelects_2&corptype=3" title=""  locale="zh_CN"
