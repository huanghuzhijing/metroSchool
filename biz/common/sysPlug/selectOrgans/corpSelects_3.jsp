...
<script type="text/javascript">
	...
	$(document).ready(function(){
			$("#plug_btnSelect_3").click(function(){ 
					...
					//
					var url = "contentSelectAction.do?method=corpSelects_3&corptype=4";
					art.dialog({id:'commonDialog1',title:'第三方监测单位选择', iframe:url, width:'600', height:'425'}).close(function(){
					  	//
