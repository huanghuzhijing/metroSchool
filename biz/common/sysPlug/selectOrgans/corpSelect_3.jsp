...
<body>
 <table class="queryTable" >
		...
		<tr>
			<td>
				<html:form action="contentSelectAction.do?method=corpSelects_3&corptype=4">
	...
	<ec:table items="organizations" var="organization"
				action="contentSelectAction.do?method=corpSelects_3&corptype=2" title=""  locale="zh_CN"
