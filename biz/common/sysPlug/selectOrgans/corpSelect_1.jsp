	...
	<script type="text/javascript">
		$(document).ready(function(){
			$(".selectButton").click(function(){ 
				parent.$("#plug_corpIds_1").val($(this).attr("paramId")); 
				parent.$("#plug_corpNames_1").val($(this).attr("paramName"));
...
<body>
 <table class="queryTable" >
	...
	<ec:table items="organizations" var="organization"
				action="contentSelectAction.do?method=corpSelects_1&corptype=2" title=""  locale="zh_CN"
