...
function windowClose(){
	parent.art.dialog({id:'suggestView'}).close();
}
...
<body>
	...
	<div class="smallBox" style="width: 98%">
		<div class="submenu">
			<span style="margin-left: 20px"><font color="#0B273C"><strong>${station_name}安全分析评估及综合建议</strong> </font>
			</span>
		</div>
			...
			<table width="100%" cellpadding="0" cellspacing="0" border="0">
				<c:if test="${situationSuggest.fileContent != null}">
					<tr>
						<td>
							<br>
							<c:out value='${situationSuggest.fileContent}' escapeXml="false"></c:out>
						</td>
					</tr>
				</c:if>
	...
	<div align="center" class="sb_div">
		...
		<input type="button" value=" 关 闭 " class="backButton"
			onclick="windowClose()" />
		<div>
</body>
</html:html>