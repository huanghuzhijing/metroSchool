				...
				<td valign="top" width="180px">
					<div style="overflow: auto; width: 240px; ">
						<script  type="text/javascript">
							...
							ecomponentTree.add('${station.station_id}','+${station.segment_id.segment_id}','${station.station_name}','${ctx}/segmentScheduleAction.do?method=list&segment_id=${station.segment_id.segment_id}&station_id=${station.station_id}&station_state=${station.station_state}&station_type=${station.station_type}','','main','','','');
							</c:forEach>
