...
<!--							</c:forEach>-->
							...
							ecomponentTree.add('+${seg.segment_id}','=${seg.line_id.line_id}','${seg.segment_name}','safeDocAction.do?method=list&qlineId=${seg.line_id.line_id}&qsegmentId=${seg.segment_id}','','main','','','');
							</c:forEach>
