	...
	$(document)
			...
			properties[1]=["title","文件标题"];
					...
					$("#btn_back")
							.click(
									function() {
									var url = "${ctx}/safeDocAction.do?method=list&qlineId=${param.qlineId}&qsegmentId=${param.qsegmentId}&qstartDate=${param.qstartDate}&qendDate=${param.qendDate}&qtypes=${param.qtypes}&ec_id=${param.fid}&ec_p=${param.ec_p}&ec_crd=${param.ec_crd}";
		...
		<fieldset>
			...
			<table class="formTable">
				...
				<td>
					...
					<td>
						<html:text property="title"  styleClass="inputText"  value="${safeDoc.title}"/>						
					</td>
				</tr>
				<tr>
				<td>
				...
				<tr>
				  <td>
					...
					<td>
						<input  type="text" readonly="readonly" id="author" name="author" class="form_input" value="${safeDoc.author}" />						
					</td>
					<td>
						创建日期：
						<span class="noRedSpan">*</span>
