...
<html>
 ...
 <frameset rows="28px,*" border="0" scrolling="no" noresize="noresize">
	...
	<frameset cols="20%,*" border="0" scrolling="auto"  noresize="noresize"/>
		<frame src="safeDocAction.do?method=listLeft" border="0" scrolling="auto" noresize="noresize"  />
	<!--	<frame name="main" src="dataEmulationAction.do?method=list" border="0" scrolling="yes" noresize="noresize" />-->
	
	<frame name="main" src="safeDocAction.do?method=list&qlineId=${qlineId}&qsegmentId=${qsegmentId}" border="0" scrolling="yes" noresize="noresize" />
