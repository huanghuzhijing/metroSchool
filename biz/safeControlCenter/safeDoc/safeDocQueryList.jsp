...
<head>
	...
	<script type="text/javascript">
		...
		function showView(id){
	    	...
	    	var url ='safeDocAction.do?method=view&flag=2&fid='+oper_id+'&qlineId=${param.qlineId}&qsegmentId=${param.qsegmentId}&qstartDate=${param.qstartDate}&qendDate=${param.qendDate}&qtypes=${param.qtypes}&ec_p='+$("input[name='ec_p']").val()+'&ec_crd='+$("[name='ec_rd']").val();
			commonUrl(url);
	  	}
...
<body>
	<table class="queryTable">
		...
		<tr>
			<td>
				<html:form
					action="safeDocAction.do?method=queryList&ec_p=${param.ec_p}&ec_id=${param.id}&ec_crd=${param.ec_crd}&qlineId=${dtaqSegment.line_id.line_id }&qsegmentId=${dtaqSegment.segment_id}">
					<table align="left">
					<tr>
							<td align="right">
								线路：
