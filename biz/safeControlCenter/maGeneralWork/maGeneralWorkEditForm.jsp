		...
		<fieldset>
			...
			<table class="formTable">
				...
				<td>
					...
					<td>
						<html:text property="general_name" styleClass="text" size="90"  value="${maGeneralWork.general_name}"/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<ex:dictSelect property="general_type" type="GeneralWorkType"
							value="${maGeneralWork.general_type}" />
					</td>
					<td>
						关注等级：
						<span class="redSpan">*</span>
					...
					<td>
						<ex:dictSelect property="general_rank" type="TaskWorkRank" value="${maGeneralWork.general_rank}"
							/>
					</td>
				</tr>
				<tr>
				<td>
					...
					<td colspan="3">
								<html:text property="allot_empids" />
								<html:text property="allot_names" size="90" styleClass="text" maxlength="50" value="${maGeneralWork.allot_names}" readonly="true"/>
				...
				<td colspan="3">
           			<html:textarea value="${maGeneralWork.general_memo}" property="general_memo" styleId="general_memo" cols="85" rows="8" onkeydown="textCounter('general_memo','spanAim5',4000)" onkeyup="textCounter('general_memo','spanAim5',4000)" ></html:textarea><br>
