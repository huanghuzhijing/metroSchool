...
function backToList(){
	var url='dtaqWarnSignAction.do?method=list&fid=${param.fid}&station_id=${param.station_id}&qstartDate=${param.qstartDate}&qendDate=${param.qendDate}&ec_p=${param.ec_p}&ec_id=${param.ec_id}&ec_crd=${param.ec_crd}'; 
	document.forms[0].action=url;
	document.forms[0].submit();
}
</script>
</head>
<content tag="heading">批示信息查询中心 </content>
<body>
<html:form enctype="multipart/form-data" action="dtaqWarnSignAction.do?method=list" method="POST" >
	...
	<html:hidden property="station_name" />
	<html:hidden property="qsigner"/>
...
<c:if test="${historys ne null}">
	...
	<logic:iterate id="history" name="historys" indexId="count">
		<tr align="center" height="20" bgcolor="#C6DFF7">
			...
			<td><fmt:formatDate value="${history.signdate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
