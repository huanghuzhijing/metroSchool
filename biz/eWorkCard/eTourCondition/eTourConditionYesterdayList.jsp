...
<body >
	<table class="queryTable" >
		...
		<tr>
			<td>
			<html:form action="eTourConditionAction.do?method=yesterdayList">
			<input name="flagPage" type="hidden" value="2"/>
					<table align="left">
						       <tr>
								<td>线路：</td>
							    <td >
...
<table class="listTable1" border="1" style="width:100%;margin:auto;font-size: 14px;border-collapse: collapse;">
									<tr class="ggHeader">
										<th width="35%">线路</th>
										<th width="23%">工点</th>
										<th width="14%">昨日巡视工程师</th>
										<th width="14%">是否巡视完成</th>
										<th width="14%">备注</th>
							...
							<table id="tablescrop1" class="listTable1" border="1" style="width:100%;margin:auto;font-size: 14px;border-collapse: collapse;">
									...
									<c:forEach items="${eTourConditions}" var="eTourCondition" varStatus="index">
										<tr>
											<td width="35%">${eTourCondition.lineId.line_name}</td>
											<td width="23%">${eTourCondition.stationId.station_name}</td>
											<td width="14%">${eTourCondition.tourEngineer}</td>
											<td width="14%"><ex:dicDisplay dictIdentify="Yesorno"  dictValue="${eTourCondition.ifFinish}"/></td>
											<td width="14%">${eTourCondition.finishRemark}</td>
										</tr>
									</c:forEach>
