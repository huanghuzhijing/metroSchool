...
<html:hidden property="monitorResult5Old" />			
 ...
 <tr >
  ...
  <tr>
    ...
    <th width="279">天气：</th>
    <td width="251"><html:text property="weather"  value="${ePatrolRecordCoverCutPre.weather}" styleClass="inputText" maxlength="100" size="30" /></td>
  ...
  <tr>
    <td height="70" colspan="6"><html:textarea property="progressNotes" value="${ePatrolRecordCoverCutPre.progressNotes}" /></td>
  </tr>
  <tr>
  ...
  <tr>
    <td height="85" colspan="2"><html:textarea property="pointSolve" value="${ePatrolRecordCoverCutPre.pointSolve}"/></td>
    <td colspan="2"><html:textarea property="implementation" value="${ePatrolRecordCoverCutPre.implementation}"/></td>
    <td colspan="2"><html:textarea property="newProblem" value="${ePatrolRecordCoverCutPre.newProblem}"/></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><html:textarea property="supportRemark1" value="${ePatrolRecordCoverCutPre.supportRemark1}"/></td>
  </tr>
  <tr>
    ...
    <td rowspan="7"><html:textarea property="supportRemark2" value="${ePatrolRecordCoverCutPre.supportRemark2}"  style="height:300px"/></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="2">
		<html:text property="conditionResult1" value="${ePatrolRecordCoverCutPre.conditionResult1}" styleClass="inputText" maxlength="100" size="30" />
	</td>
    <td rowspan="10">
		<html:textarea property="conditionRemark" value="${ePatrolRecordCoverCutPre.conditionRemark}"  style="height:300px"/>
	</td>
  </tr>
  <tr>
    <th height="34" colspan="2">基坑水文情况</th>
    <td colspan="2">
		<html:text property="conditionResult2" value="${ePatrolRecordCoverCutPre.conditionResult2}" styleClass="inputText" maxlength="100" size="30" />
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="2">
    	<html:text property="conditionResult7" value="${ePatrolRecordCoverCutPre.conditionResult7}" styleClass="inputText" maxlength="100" size="30" />
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td rowspan="8"><html:textarea property="safetyRemark"  value="${ePatrolRecordCoverCutPre.safetyRemark}" style="height:300px"/></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <div class="monitorResult1" style="display: none">
   		 缺失项:<html:text property="monitorResult1Temp" value="${ePatrolRecordCoverCutPre.monitorResult1Temp}" styleClass="inputText" maxlength="100" size="30" />
   </div>
   </td><td rowspan="5"><html:textarea property="monitorRemark" value="${ePatrolRecordCoverCutPre.monitorRemark}"  style="height:300px"/></td>
  </tr>
  <tr>
    <th height="34" colspan="2">今日监测点损坏情况</th>
    <td colspan="2"><html:text property="monitorResult2" value="${ePatrolRecordCoverCutPre.monitorResult2}" styleClass="inputText" maxlength="100" size="30" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="2"><html:text property="monitorResult4" value="${ePatrolRecordCoverCutPre.monitorResult4}" styleClass="inputText" maxlength="100" size="30" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="2"><html:text property="riskTrackResult1" value="${ePatrolRecordCoverCutPre.riskTrackResult1}" styleClass="inputText" maxlength="100" size="30" /></td>
    <td rowspan="6"><html:textarea property="riskTrackRemark" value="${ePatrolRecordCoverCutPre.riskTrackRemark}"  style="height:300px"/></td>
  </tr>
  <tr>
    <th height="36" colspan="2">压力管线情况（给水管）</th>
    <td colspan="2"><html:text property="riskTrackResult2" value="${ePatrolRecordCoverCutPre.riskTrackResult2}" styleClass="inputText" maxlength="100" size="30" /></td>
  </tr>
  <tr>
    <th height="34" colspan="2">压力管线情况（燃气管）</th>
    <td colspan="2"><html:text property="riskTrackResult3" value="${ePatrolRecordCoverCutPre.riskTrackResult3}" styleClass="inputText" maxlength="100" size="30" /></td>
  </tr>
  <tr>
    <th height="35" colspan="2">周边建（构）筑物变形情况</th>
    <td colspan="2"><html:text property="riskTrackResult4" value="${ePatrolRecordCoverCutPre.riskTrackResult4}" styleClass="inputText" maxlength="100" size="30" /></td>
  </tr>
  <tr>
    <th height="36" colspan="2">周边道路（地面）变形、裂缝</th>
    <td colspan="2"><html:text property="riskTrackResult5" value="${ePatrolRecordCoverCutPre.riskTrackResult5}" styleClass="inputText" maxlength="100" size="30" /></td>
  </tr>
  <tr>
    <th height="34" colspan="2">邻近施工情况</th>
    <td colspan="2"><html:text property="riskTrackResult6" value="${ePatrolRecordCoverCutPre.riskTrackResult6}" styleClass="inputText" maxlength="100" size="30" /></td>
  </tr>
   <tr>
    <th height="35">特殊工序情况说明</th>
    <td colspan="5">
    	<html:textarea property="specialProgress" value="${ePatrolRecordCoverCutPre.specialProgress}"/>
    </td>
  </tr>
  <tr>
    <th height="39" colspan="3">现场巡视照片存放路径</th>
    <td colspan="3"><html:text property="picPath" value="${ePatrolRecordCoverCutPre.picPath}"  styleClass="inputText" maxlength="100" size="30" /></td>
  </tr>
  <tr>
