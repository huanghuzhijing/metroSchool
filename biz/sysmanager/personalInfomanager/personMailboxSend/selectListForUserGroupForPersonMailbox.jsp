...
<body onload="init_()">
	<div class="listButtonDiv">
				<input type="radio" id="org" value="1" 
					onclick="checkde()">
				按组织选择
				<input type="radio" id="gangwei" value="2" checked="checked" onclick="checkde_()">
				按用户组选择
			...
			<td valign="top">
				<div style="width: 160px;text-align:left">
					<script language='javascript'>
							...
							organizationTree.add('-1',-99,'用户组树','${ctx}/employeeAction.do?method=selectListForUserGroupForPersonMailbox');
							<c:forEach items="${userGroupsTree}" var="userGroup">
								organizationTree.add('${userGroup.id}','-1','${userGroup.usergroupname}','employeeAction.do?method=selectListForUserGroupForPersonMailbox&poidid=${userGroup.id}','','','','');
							</c:forEach>
					...
					<tr>
						<td>
							<fieldset>
								...
								<div>
									<html:form
										action="employeeAction.do?method=selectListForUserGroupForPersonMailbox">
	...
	<div class="saveDiv">
		<input type="button" icon="icon_query" value=" 确定 " onclick="initvalue()"></input>
	</div>
</body>
</html:html>
