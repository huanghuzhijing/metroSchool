...
<head>
	...
	$(document).ready(function(){
       ...
       $("#btn_back").click(function(){
       		location.href='employeeExtendAction.do?method=list&qempcode=${param.qempcode}&qempname=${param.qempcode}&qsex=${param.qsex}&qe_org=${param.qe_org}&ec_crd=${param.ec_crd}';
       });
		...
		<fieldset >
			...
			<table class="formTable">
						...
						<tr>
							...
							<td>
								<html:hidden property="qe_orgid"  />
							     <html:text property="qe_orgName"  />
