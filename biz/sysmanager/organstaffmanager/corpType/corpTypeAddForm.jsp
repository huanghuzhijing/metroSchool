		...
		<fieldset >
			...
			<table class="formTable">
						...
						<tr>
							...
							<td>
							<input id="codeBlur" onkeypress="return regInput0(this,String.fromCharCode(event.keyCode))" tableName="SYS_CORP_TYPE" fieldValue="typecode" name="typecode" class="inputText" size="30" value="<ex:codeRlueDisPlay  tableName="SYS_CORP_TYPE" fieldValue="typecode" ruleCode='corpTypeNo'  />" />
							</td>
							<td>
