		...
		<legend>[基本信息]</legend>
			<table class="formTable">
						...
						<tr>
							...
							<td>
									<input id="codeChange" onkeypress="return regInput0(this,String.fromCharCode(event.keyCode))" tableName="SYS_CORP" fieldValue="corpcode" name="corpcode" class="inputText" size="30" value="${corp.corpcode}"  />
							</td>
							<td>
