...
<body>
	<html:form action="corpEmployeeAction.do"  method="POST">
		...
		<input name="static_corptype" value="${param.static_corptype}" type="hidden" />
		<!-- 查询条件 结束-->
		<fieldset >
		<legend>参建单位员工-增加</legend>
			<table class="formTable">
						...
						<tr>
							...
							<td>
								<html:text property="birthday"  styleClass="inputText"  onfocus="WdatePicker()"/>
							</td>
							<td>
								电子邮件：<span class="noRedSpan">*</span>
							</td>
							<td><html:text maxlength="20" property="email" styleClass="inputText" />
							</td>
						</tr>
						<tr>
							<td>
