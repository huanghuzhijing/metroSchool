...
<head>
	...
	//	});  
       ...
       $("#btn_back").click(function(){
       		location.href='organizationOutAction.do?method=list&ec_crd=${param.ec_crd}&qf_economictype=${param.qf_economictype}&qf_name=${qf_name}';
       });
       //
       $("#btn_save").click(function(){
		...
		$("#codeBlur").blur(function(){ 
			 $.ajax({
					   ...
					   data: "code="+$("input[name='f_no']").val()+"&out=out",
