...
<head>
	...
	$(document).ready(function(){
       ...
       $("#btn_back").click(function(){
       		location.href='employeeAction.do?method=list&static_orgid=${param.static_orgid}&name=${param.name}&ec_id=${param.employee_id}&qempcode=${param.qempcode}&qempname=${param.qempname}&qsex=${param.qsex}&ec_crd=${param.ec_crd}&ec_p=${param.ec_p}';
       });
        	//验证自动编码重复性
		$("#codeBlur").blur(function(){ 
			 $.ajax({
					   ...
					   data: "code="+$("input[name='employee_code']").val()+"&id=${param.employee_id}",
		...
		<fieldset >
			...
			<table class="formTable">
						...
						<tr>
							...
							<td>
							<c:set var="employee_birthday"><fmt:formatDate value="${object.employee_birthday}" pattern="yyyy-MM-dd"/></c:set>
							<html:text property="employee_birthday" value="${object.employee_birthday}" styleClass="inputText"  onfocus="WdatePicker()"/>
							</td>
						</tr>
						<tr>
