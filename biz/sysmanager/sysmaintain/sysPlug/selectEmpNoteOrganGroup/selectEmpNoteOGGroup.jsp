		  ...
		  $('#btn_save').click(function(){
		   ...
		   $("#select_organ").click(function() {
				...
				$("#select_corp").attr("checked","");
					    ...
					    parent.$("#plug_organSelect").html($("#plug_groupSelect",parent.document).html());
			...
			<td valign="top">
				<div style="width: 160px;text-align:left">
					<script language='javascript'>
							...
							organizationTree.add('-1',-99,'用户组树','${ctx}/employeeAction.do?method=selectEmpNoteOGGroup&deptFlag=${param.deptFlag}');
							<c:forEach items="${userGroupsTree}" var="userGroup">
								organizationTree.add('${userGroup.id}','-1','${userGroup.usergroupname}','employeeAction.do?method=selectEmpNoteOGGroup&poidid=${userGroup.id}&deptFlag=${param.deptFlag}','','','','');
							</c:forEach>
					...
					<tr>
						<td>
							<fieldset>
								...
								<div>
									<html:form
										action="employeeAction.do?method=selectEmpNoteOGGroup&deptFlag=${param.deptFlag}">
