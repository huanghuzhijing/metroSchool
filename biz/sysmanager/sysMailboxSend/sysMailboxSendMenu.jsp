	...
	$(document).ready(function(){
	 //审核
       $(".leftHref").click(function(){
      	...
      	//+'&ec_crd='+ $("[name='ec_crd']",parent.main.document).val()
      	$(this).attr("href",url);
       });
	});
</script>
				...
				<table style="margin-top: 10px;">
					<tr height="40">
						<td
							...
							<div style="font-size: 12px; margin-left: 25px;">
								<a style="color: #024280" href="sysMailboxSendAction.do?method=create&flag=0"
								 class="leftHref"	target="main">写信息</a>
							</div>
						</td>
					</tr>
					<tr height="40">
						<td
							...
							<div style="font-size: 12px; margin-left: 25px;">
								<a style="color: #024280" href="sysMailboxReceiveAction.do?method=list&flag=4"
									class="leftHref" target="main">收信箱(<span id="noread">${allreceive}</span>)</a>
							</div>
					...
					<tr height="40">
						<td
							...
							<div style="font-size: 12px;; margin-left: 25px;">
								<a style="color: #024280" href="sysMailboxSendAction.do?method=list&flag=1"
					...
					<tr height="40">
						<td
							...
							<div style="font-size: 12px;; margin-left: 25px;">
								<a style="color: #024280" href="sysMailboxSendAction.do?method=list&flag=2"
					...
					<tr height="40">
						<td
							style="background-image: url(${ctx}/styles/img/garabge.gif); background-repeat: no-repeat; background-position: left">
							<div style="font-size: 12px;; margin-left: 25px;">
								<a style="color: #024280" href="sysMailboxReceiveAction.do?method=list&flag=5"
									class="leftHref"	target="main">垃圾箱(<span id="Draft">${garabge}</span>)</a>
							</div>
						</td>
					</tr>
				</table>
