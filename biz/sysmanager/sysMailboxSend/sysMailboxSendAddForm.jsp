...
<input type="hidden" name="method" value="save">
 ...
 <fieldset >
			<legend>写信息</legend>
					<table class="formTable">
						...
						<tr>
							...
							<td colspan="3">
								<ex:dictRadio property="isimport" type="Isornoimport" defaultValue="0"/>
							</td>
						</tr>
						<tr>
							<td>
							...
							<td colspan="3">
								<ex:dictRadio property="sendType" type="SendType" defaultValue="1" onclick="displayTimeTr(this.value)"/><font color="blue">（备注：发送类型只适用于 [发送] 按钮，对 [保存] 按钮无效！） </font>
							</td>
						</tr>
		...
		<div class="saveDiv">
			...
			<c:if test="${param.createType==1 || param.createType==2 }">
				<input value="返 回" type="button" id="btn_back" icon="icon_back"/>
			</c:if>
