...
<head>
	...
	$(document).ready(function(){
       ...
       $("#btn_save").click(function(){
			...
			properties[1]=["data_short_name","字典项值"];
	...
	<content tag="heading">数据字典项管理</content>
<body>
	<html:form action="dataDictRecordAction.do" method="POST">
		<input type="hidden" name="method" value="save" />
		<html:hidden property="data_id"/>
		...
		<legend>数据字典项-新增</legend>
			<table class="formTable">
						...
						<tr>
							...
							<td colspan="3">
								<html:text maxlength="20" property="description" styleClass="inputText" size="50"/>
							
								<span class="memoFont" id="spanSummary" style="display: inline"></span>
							</td>
						</tr>
					</table>
				</fieldset>
