			...
			<table class="formTable" >
					...
					<tr>
						...
						<td >
							...
							<input type="button" icon="icon_currWeek" onclick="javascript:showUploadDialogAndRefresh('dtaqSegmentScheduleAction.do?method=uploadFile&flag=1&mainTableName=${maintable}',900,700);" style="width: 76px; height: 65px; cursor:pointer" value="单附件上传" alt="进入文件上传页面" />
...
<%--							<input id="fileAddr_" class="inputText" type="file" onchange="fileSelect(this)" name="fileAddr_" size="30"/>--%>
					...
					<tr>
						...
						<td >
							...
							<input type="button" icon="icon_currWeek" onclick="javascript:showUploadDialogAndRefresh('dtaqSegmentScheduleAction.do?method=uploadFile&flag=2&mainTableName=${maintable}',900,700);" style="width: 76px; height: 65px; cursor:pointer" value="单附件上传" alt="进入文件上传页面" />
...
<%--							<input id="fileAddr_" class="inputText" type="file" onchange="fileSelect(this)" name="fileAddr_" size="30"/>--%>
					 ...
					 <tr>
						...
						<td >
							...
							<input type="button" icon="icon_currWeek" onclick="javascript:showUploadDialogAndRefresh('dtaqSegmentScheduleAction.do?method=uploadFile&flag=3&mainTableName=${maintable}',900,700);" style="width: 76px; height: 65px; cursor:pointer" value="单附件上传" alt="进入文件上传页面" />
