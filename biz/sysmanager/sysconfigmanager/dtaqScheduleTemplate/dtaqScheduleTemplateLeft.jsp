				...
				<td valign="top" width="180px">
					<div style="overflow: auto; width: 240px; ">
						<script  type="text/javascript">
							...
							ecomponentTree.add('-1',-99,'树','','','main','','','');
							
							<c:forEach items="${stations}" var="station">
							ecomponentTree.add('${station.station_id}','+${station.segment_id.segment_id}','${station.station_name}','${ctx}/dtaqScheduleTemplateAction.do?method=list&station_id=${station.station_id}&station_state=${station.station_state}&station_type=${station.station_type}','','main','','','');
							</c:forEach>
