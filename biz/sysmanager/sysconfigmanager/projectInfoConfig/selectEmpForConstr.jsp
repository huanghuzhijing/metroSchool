...
<body>
	<html:form enctype="multipart/form-data" action="projectInfoConfigAction.do?method=saveEmpForConstr" method="POST">
	...
	<ec:table items="employees" var="employee" 
		action="projectInfoConfigAction.do?method=selectEmpForConstr" title=""  locale="zh_CN"
