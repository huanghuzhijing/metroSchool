...
<%@ include file="/commons/meta.jsp"%>
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var segids='${projectInfo.segmentid}';
...
<body>
	<html:form enctype="multipart/form-data" action="projectInfoConfigAction.do?method=saveSeg" method="POST">
		...
		<input name="cfgId" value="${cfgId }" type="hidden">
	</html:form>
	<ec:table items="prjSegmentInfos" var="prjSegmentInfo" 
		action="projectInfoConfigAction.do?method=selectSeg" title=""  locale="zh_CN"
