...
<body>
	<html:form enctype="multipart/form-data" action="projectInfoConfigAction.do?method=saveEmpForSurv" method="POST">
	...
	<ec:table items="employees" var="employee" 
		action="projectInfoConfigAction.do?method=selectEmpForConstr" title="" width="100%" locale="zh_CN"
