...
var selectpoint = "";
function backToList() {
  location.href="dtaqCheckpointUseAction.do?method=list&dtaqProjMachCheckpointList_page=${dtaqProjMachCheckpointList_page}&station_id=${param.station_id}&station_state=${station_state}&segment_id=${segment_id}&isthird=${isthird}";
}
