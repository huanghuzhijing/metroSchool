...
<ec:table items="dtaqDatas" var="dtaqData" action="dtaqDataInfoQueryAction.do"
	...
	retrieveRowsCallback="limit" filterRowsCallback="limit" sortRowsCallback="limit">
  	<ec:row highlightRow="true" >
		...
		<ec:column property="init_value" calcTitle="init_value" title="${type.init_value_title}"/>
		<ec:column property="curr_value" calcTitle="curr_value" title="${type.current_value_title}"/>
		<ec:column property="prev_value" calcTitle="prev_value" title="${type.pre_value_title}"/>
	    ...
	    <div align="center">
	    	<input type="button" value="时序曲线" class="button1" onclick="showComparePointTimes('${dtaqData.point_id.point_id}','${dtaqData.info_id.type_id.type_kind}')">
	    </div>
	  </ec:column>
	</ec:row>
</ec:table>
