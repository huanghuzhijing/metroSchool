...
<ec:table items="dtaqDatas" var="dtaqData" action="dtaqDataInfoQueryAction.do"
	...
	retrieveRowsCallback="limit" filterRowsCallback="limit" sortRowsCallback="limit">
  	<ec:row highlightRow="true" >
		...
		<ec:column property="point_code" calcTitle="point_code" title="深度"/>
	    ...
	    <div align="center">
	    	<input type="button" value="时序曲线" class="button1" onclick="showComparePartTimes3('${dtaqData.point_id.point_id}','${dtaqData.info_id.info_id}')">
	    </div>
	  </ec:column>
	</ec:row>
</ec:table>
