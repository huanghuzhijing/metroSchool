				...
				<td valign="top" width="180px">
					<div style="overflow: auto; width: 240px; ">
						<script  type="text/javascript">
							...
							ecomponentTree.add('-${station.station_id}','+${station.segment_id.segment_id}','${station.station_name}','','','main','','','');
							ecomponentTree.add('.${station.station_id}','-${station.station_id}','施工方','dtaqDataInfoQuery2Action.do?method=loadPointPic&station_id=${station.station_id}&segment_id=${station.segment_id.segment_id}&organ_type=O&isthird=N','','main','','','');
							ecomponentTree.add('..${station.station_id}','-${station.station_id}','第三方','dtaqDataInfoQuery2Action.do?method=loadPointPic&station_id=${station.station_id}&segment_id=${station.segment_id.segment_id}&organ_type=T&isthird=Y','','main','','','');
							</c:if>
							</c:forEach>
