...
<table class="formTable">
	...
	<tr>
		...
		<td>
			<input type="checkbox"  name="tempIsGISShow" value="1" <c:if test="${dtaqLine.isGisShow==1}">checked</c:if> />
		</td>
	</tr>
	<tr>
		<td>
	...
	<tr>
		...
		<td>
			<input type="checkbox"  name="tempShowType_1" value="1" <c:if test="${dtaqLine.showType==1||dtaqLine.showType==3}">checked</c:if> />建设期
			<input type="checkbox"  name="tempShowType_2" value="2" <c:if test="${dtaqLine.showType==2||dtaqLine.showType==3}">checked</c:if> />运营期
		</td>
	</tr>
	<tr>
		<td>
	...
	<tr>
		...
		<td>
			<html:text property="mapFix" styleClass="inputText" maxlength="100" size="30" />
