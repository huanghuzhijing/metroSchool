	...
	//黄色报警
		...
		if(rel_change_error == 3){
			if(abs_change_error == -2){
				memo = "本次应力值大于等于负绝对警戒值小于负绝对临界值,且变化速率大于等于相对警戒值";
			}else if(abs_change_error == 1){
				memo = "本次应力值大于等于负绝对临界值小于正绝对临界值,且变化速率大于等于相对警戒值";
			}else if(abs_change_error == 2){
				memo = "本次应力值大于等于正绝对临界值小于正绝对警戒值,且变化速率大于等于相对警戒值";
			}
		}else if(rel_change_error == 2){
			if(abs_change_error == -2){
				memo = "本次应力值大于等于负绝对警戒值小于负绝对临界值,且变化速率大于等于相对临界值小于相对警戒值";
			}else if(abs_change_error == 2){
				memo = "本次应力值大于等于正绝对临界值小于正绝对警戒值,且变化速率大于等于相对临界值小于相对警戒值";
			}
		}
	}
	//蓝色报警
		...
		if(rel_change_error == 2){
			if(abs_change_error == 1){
				memo =  "本次应力值大于等于负绝对临界值小于正绝对临界值,且变化速率大于等于相对临界值小于相对警戒值";
			}
		}
		else if(rel_change_error == 1){
			if(abs_change_error == -2){
				memo =  "本次应力值大于等于负绝对警戒值小于负绝对临界值,且变化速率小于相对临界值";
			}else if(abs_change_error == 2){
				memo =  "本次应力值大于等于正绝对临界值小于正绝对警戒值,且变化速率小于相对临界值";
			}
		}
	}
					...
					<table border="0" cellspacing="0" cellpadding="0"
						...
						<tbody>
							...
							<c:forEach items="${points}" var="point">
								...
								<c:if test="${operate_mode == 'edit'}"><td align="center"><input type="button" value="时序曲线" class="button1" onclick="showPointTimes(${point.point_id})"></td></c:if></tr>
