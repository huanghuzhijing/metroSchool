	   ...
	   $(document).ready(function(){
			...
			$("#btn_save").click(function(){
			 $.ajax({
				   ...
				   data:"part_name="+jQuery("[name='part_name']").val()+"&type_id=${type_id}&station_id=${qstation_id}&part_id=",
			...
			$("#btn_back").click(function(){ 
				location.href='dtaqPartAction.do?method=list&ec_crd=${param.ec_crd}&organ_type=${param.organ_type}&qlineId=${qlineId}&qsectionId=${qsectionId}&qstation_id=${qstation_id}&type_id=${type_id}&station_state=${param.station_state}';
			});  
...
<body>
	<html:form enctype="multipart/form-data" action="dtaqPartAction.do" method="POST">
       ...
       <input name="type_id" value="${type_id}" type="hidden" />
       <html:hidden property="organ_type" />  
        <html:hidden property="qstation_id" />  
