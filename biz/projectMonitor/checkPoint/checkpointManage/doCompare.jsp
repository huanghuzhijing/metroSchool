...
function typeChanged() {
  location.href="${ctx}/dtaq/autoCheckpointMgmt.do?method=doCompare&isthird=${isthird}&__skip__&station_id=${station_id}&type_id="+jQuery("[name='type_id']").val();
}

function partChanged() {
  location.href="${ctx}/dtaq/autoCheckpointMgmt.do?method=doCompare&isthird=${isthird}&__skip__&station_id=${station_id}&type_id="+jQuery("[name='type_id']").val()+"&part_id="+jQuery("[name='part_id']").val();
}

function pointChanged() {
    location.href="${ctx}/dtaq/autoCheckpointMgmt.do?method=doCompare&isthird=${isthird}&__skip__&station_id=${station_id}&type_id="+jQuery("[name='type_id']").val()+"&part_id="+jQuery("[name='part_id']").val()+"&point_id="+jQuery("[name='point_id']").val();
}
...
<body>
<html:form action="/dtaq/autoCheckpointMgmt">
