		...
		<fieldset >
			...
			<table class="formTable" >
					<COLGROUP>
						...
						<td >
					        <html:select property="part_id" value="${dtaqCheckpoint.partId.part_id}">
...
<%--						</td>--%>
<%--						<td>--%>
<%--						<input type="text" id="init_date" name="initDate" class="form_input" value='<fmt:formatDate pattern="yyyy-MM-dd HH" value="${dtaqCheckpoint.init_date}"/>' onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH'})" onchange="reValue()"/>--%>
<%--						</td>--%>
					</tr>	
