...
<script type="text/javascript" src="${ctx}/scripts/jquery-easyui-1.0.2/jquery.easyui.min.js"></script>
	...
	<script type="text/javascript">
	   $(document).ready(function(){
			...
			location.href='dtaqAutoCheckpointAction.do?method=index&ec_crd=${param.ec_crd}&organ_type=${organ_type}&qlineId=${param.qlineId}&qsectionId=${param.qsectionId}&station_id=${param.station_id}&type_id=${param.type_id}&part_id=${param.part_id}&station_state=${param.station_state}';
	  });
		});
...
<body>
	<html:form enctype="multipart/form-data" action="dtaqAutoCheckpointAction.do" method="POST" styleId="pointMgmt">
		...
		<fieldset >
			...
			<table class="formTable" >
					...
					<td>
						...
						<td>
							<html:text property="init_date" styleClass="inputText"  size="30"  value="${now_date}" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH'})"/>
						</td>
					</tr>	
      ...
      <tr>
    	<td align="center">&nbsp;<%@include file="/biz/projectMonitor/checkPoint/dtaqAutoCheckpoint/dtaqAutoCheckpointAdd2.jsp" %></td>
      </tr>
</table>
	</html:form>
</body>
