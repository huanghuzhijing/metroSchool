...
function backToList() {
  location.href="${ctx}/dtaqAutoCheckpointAction.do?method=index&qlineId=${qlineId}&qsectionId=${qsectionId}&organ_type=${organ_type}";
}
function importExcel(obj) {
	...
	document.forms[0].action = '${ctx}/dtaqAutoCheckpointAction.do?method=autoDoImport';
...
<body>
<html:form action="dtaqAutoCheckpointAction.do" enctype="multipart/form-data" method="post">
  ...
  <table class="formTable" >
    ...
    <tr>
      ...
      <td colspan="3">
        ...
        <a href="${ctx}/dtaqAutoCheckpointAction.do?method=downloadTemplate&qsectionId=${qsectionId}&__skip__">测点导入事例下载</a>
      </td>
    </tr>
