				...
				<td valign="top" width="180px">
					<div style="overflow: auto; width: 240px; ">
						...
						//	</c:forEach>
							...
							ecomponentTree.add('${seg.e_org.f_id}','+${seg.segment_id}','${seg.e_org.f_name}','constructorAction.do?method=list&lineId=${seg.line_id.line_id}&segmentId=${seg.segment_id}&organId=${seg.e_org.f_id}','','main','','','');
							</c:forEach>
