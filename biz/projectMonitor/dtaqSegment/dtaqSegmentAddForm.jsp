...
<input type="hidden" name="lineId" value="${param.qlineId}">
...
<table class="formTable">
	...
	<tr>
		...
		<td>
			<ex:numberInput property="segment_code" styleClass="inputText" maxlength="100" size="5" onchange="validateCode(this.value)"/><font color="#50A2E6" size="2">(示例说明:01015,'01'表示线路流水号即一号线,'015'表示标段流水号即15标)</font> 
		</td>
	</tr>
	  	<tr>
...
<tr>
		...
		<td colspan="3"> 
			<div style="float:left">
			<html:hidden property="corpIds" onchange="validateCrop()"/>
			<html:text property="corpNames" styleClass="inputText" onchange="validateCrop()" size="70" readonly="true"/>
		    </div>
		     <div style="float:left">
	...
	<tr>	
		...
		<td colspan="3">  
		    <div style="float:left">
			<html:hidden property="corpIds_1" />
			<html:text property="corpNames_1" styleClass="inputText" maxlength="100" size="70" readonly="true"/>
		    </div>
		     <div style="float:left">
