...
function backToList(){
		location.href = '${ctx}/dtaqDataInfoQuery3Action.do?method=list&qlineId=${param.qlineId}&qsegmentId=${param.qsegmentId}&qstationId=${param.qstationId}&qtypeId=${param.qtypeId}&qorganType=${param.qorganType}&qstartDate=${param.qstartDate}&qendDate=${param.qendDate}&thirdList=${param.thirdList}';
}
...
function showPartTimes(part_id) {
		...
		window.open(url,'','height='+sheight+',width='+swidth+',top=0,left=0,toolbar=no,menubar=no,scrollbars=yes, resizable=no,location=no, status=no,titlebar=no')
	  	...
	  	//var url ="${ctx}/dtaqDataInfoQuery3Action.do?method=showPartTimes&part_id="+part_id+"&type_kind="+type_kind+"&qstartDate=${param.qstartDate}&qendDate=${param.qendDate}&from=data";
...
function showComparePointTimes(point_id) {
		...
		//  var url ="${ctx}/dtaqDataInfoQuery3Action.do?method=showComparePointTimes&point_id="+point_id+"&type_kind="+type_kind+"&qstartDate=${beginMonDate}&qendDate=${endDatePic}&from=data";
...
function showComparePointTimes3(point_id) {
	...
	//var url ="${ctx}/dtaqDataInfoQuery3Action.do?method=showComparePointTimes3&point_id="+point_id+"&type_kind="+type_kind+"&qstartDate=${beginWeekDate}&qendDate=${endDatePic}&from=data";
...
<html:form enctype="multipart/form-data" action="dtaqDataInfoQuery3Action.do" method="POST" >
<fieldset>
