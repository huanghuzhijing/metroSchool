...
function queryView(info_id,part_id){
	...
	var href="${ctx}/dtaqDataInfoQuery3Action.do?method=view&info_id="+info_id+"&queryPart="+part_id+"&query2Part=${query2Part}"+param;
	return href ;
}
...
<c:forEach items="${dtaqparts}" var="datapart">
  positionTree.add('SL_${datapart.part_id}','-1','${datapart.part_name}',queryView('${dtaqDataInfo.info_id}','${datapart.part_id}'),null,null,'${ctx}/images/dtaq/line.png','${ctx}/images/dtaq/line.png'); 
</c:forEach>
